...
import { UpdatedTopSliderPage } from '@/pages/modules/new_editor/publict-content/top-slider/updated'
import { LogActivityPage } from '@/pages/modules/new_editor/publict-content/top-slider/log'
import { UseGetTopSliderDetail } from '@/pages/modules/new_editor/publict-content/top-slider/detail'
import { UseGetBottomSliderDetail } from '@/pages/modules/new_editor/publict-content/bottom-slider/detail'
import { UpdatedBottomSlider } from '@/pages/modules/new_editor/publict-content/bottom-slider/updated'
import { LogBottomActivityPage } from '@/pages/modules/new_editor/publict-content/bottom-slider/log'
import { DetailNewsManagementEditorPage } from '@/pages/modules/new_editor/publict-content/news/detail'
import { NewsManagementEditorUpdated } from '@/pages/modules/new_editor/publict-content/news/updated'
import { LogActivityNewsManagementEditorPage } from '@/pages/modules/new_editor/publict-content/news/log-data'
import { DetailImpactInnovationPage } from '@/pages/modules/new_editor/publict-content/impact-innovation/detail'
import { UpdatedImpactInnovationPage } from '@/pages/modules/new_editor/publict-content/impact-innovation/updated'
import { LogActivityImpactInnovationPage } from '@/pages/modules/new_editor/publict-content/impact-innovation/log'
import { AnnouncementManagementEditorDetailPage } from '@/pages/modules/new_editor/publict-content/announcement/detail'
import { LogActivityAnnouncementManagementEditorPage } from '@/pages/modules/new_editor/publict-content/announcement/log'
import { UpdatedAnnouncementManagementEditor } from '@/pages/modules/new_editor/publict-content/announcement/updated'
import { AgendaManagementEditorDetailPage } from '@/pages/modules/new_editor/publict-content/agenda/detail'
import { UpdatedAgendaManagementEditorPage } from '@/pages/modules/new_editor/publict-content/agenda/updated'
import { LogActivityAgendaManagementEditorPage } from '@/pages/modules/new_editor/publict-content/agenda/log'
import { DetailFacilitiesPage } from '@/pages/modules/new_editor/publict-content/facilities/detail'
import { UpdatedFacilitiesPage } from '@/pages/modules/new_editor/publict-content/facilities/updated'
import { LogActivityFacilitiesPage } from '@/pages/modules/new_editor/publict-content/facilities/log'
import { UpdatedAchievementPage } from '@/pages/modules/new_editor/publict-content/achievement/updated'
import { DetailAchievementPage } from '@/pages/modules/new_editor/publict-content/achievement/detail'
import { LogActivityAchievement } from '@/pages/modules/new_editor/publict-content/achievement/log'
import { DetailPromotionPage } from '@/pages/modules/new_editor/publict-content/promotion/detail'
import { LogActivityPromotionManagementEditorPage } from '@/pages/modules/new_editor/publict-content/promotion/log'
import { UpdatedPromotionManagementEditor } from '@/pages/modules/new_editor/publict-content/promotion/updated'
