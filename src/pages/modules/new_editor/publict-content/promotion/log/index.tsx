...
import { UseGetLogPromotionEditor, UseGetPromotionManagementEditorDetail } from '../hooks/index'

export const LogActivityPromotionManagementEditorPage = () => {
  const { id } = useParams()
  const { logData, loading, meta } = UseGetLogPromotionEditor(id ?? '')
