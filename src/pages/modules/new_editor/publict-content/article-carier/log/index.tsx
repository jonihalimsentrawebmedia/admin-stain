...
import {
  UseGetCarrierArticleDetail,
  UseGetLogArticleCarrier,
} from '@/pages/modules/pusat-karir/public-content/article/hooks'

export const LogEditorArticleCarrierPage = () => {
  const { id } = useParams()
  const { logData } = UseGetLogArticleCarrier(id ?? '')
