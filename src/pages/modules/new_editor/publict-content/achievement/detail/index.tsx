              ...
              <>
                <div className={'flex items-center gap-2'}>
                  ...
                  <p className="text-blue-600 font-semibold">
                    ...
                    <ButtonGoToGuide
                      titleGuide={`Detail Prestasi`}
                      valueGuide="EDITOR_APPROVE_KONTEN_PUBLIK"
                    />
                  <Link
                    to={`/modules/editor/public-content/achievement/edit/${detail?.id_prestasi}`}
                  >
                    <Button
                      size={'sm'}
                      variant={'outline'}
                  ...
                  <Link
                    to={`/modules/editor/public-content/achievement/log/${detail?.id_prestasi}`}
                  >
                    <Button
                      size={'sm'}
                      variant={'outline'}
