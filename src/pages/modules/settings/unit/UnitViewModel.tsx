      ...
      cell: (row) => {
        ...
        return (
          <div className="flex gap-2 items-center">
            ...
            <Link to={`/modules/settings/unit/detail/${values.id_satuan_organisasi}`}>
              <IconDetail />
            </Link>
            {/* Tombol Kuning (Asumsi: Edit) */}
            <Link to={`/modules/settings/unit/edit/${values.id_satuan_organisasi}`}>
              <IconEdit />
            </Link>
            ...
            <ButtonDelete
              ...
              description={
                <p>
                  Anda akan menghapus unit “{values.nama}”. Apakah Anda yakin untuk menghapus unit
                  yang dipilih?
                </p>
              }
