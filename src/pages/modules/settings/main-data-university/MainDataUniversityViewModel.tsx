      ...
      cell: (row) => {
        ...
        return (
          <div className="flex gap-2 items-center">
            ...
            <Link
              to={`/modules/settings/main-data-university/edit/${values.id_satuan_organisasi}`}
            >
              <IconEdit />
            </Link>
            ...
            <ButtonDelete
              ...
              description={
                <p>
                  Anda akan menghapus universitas “{values.nama}”. Apakah Anda
                  yakin untuk menghapus universitas yang dipilih?
                </p>
              }
