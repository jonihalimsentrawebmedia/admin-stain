...
const ProdiViewModel = () => {
  ...
  const columns: ColumnDef<any>[] = [
    ...
    // Kolom Fakultas Asal
    { accessorKey: "fakultas_asal", header: "Fakultas Asal" },
      ...
      cell: (row) => {
        ...
        return (
          <div className="flex gap-2 items-center">
            ...
            <Link
              to={`/modules/settings/prodi/detail/1`}
            ...
            <Link
              to={`/modules/settings/prodi/edit/1`}
            ...
            <ButtonDelete
              description={
                <p>
                  Anda akan menghapus prodi “Sastra Inggris”. Apakah Anda yakin
