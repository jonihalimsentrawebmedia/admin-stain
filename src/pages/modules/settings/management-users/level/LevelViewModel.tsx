...
const LevelViewModel = () => {
  ...
  const columns: ColumnDef<LevelUserList>[] = [
    ...
    },
    {
      ...
      cell: (row) => {
        const values = row.row.original
        return <div className="">{values.kelompok=="" ? 'Tidak Ada' : values.kelompok}</div>
      },
    },
      ...
      cell: (row) => {
        ...
        return (
          <div className="flex gap-2 items-center">
            ...
            <Link to={`/modules/settings/management-users/level/edit/${values.id_level}`}>
              <IconEdit />
            </Link>
            ...
            <ButtonDelete
              ...
              description={
                <p>
                  Anda akan menghapus level user “{values.nama}”. Apakah Anda yakin untuk menghapus
                  level yang dipilih?
                </p>
              }
            />
