...
export const ButtonSubmissionPromotionProdi = (data?: IPromotion) => {
  ...
  const HandleSubmission = async () => {
    setLoading(true)
    await AxiosClient.patch(`/prodi/promosi/${data?.id_promosi}/status-publish`, {
  ...
  return (
    <>
      ...
      <DialogCustom
        ...
        description={'Apakah anda yakin untuk mengajukan Promosi yang dipilih ke editor?'}
      >
        <div className={'flex flex-col gap-2.5'}>
          {data?.promosi_gambar_tambahan && data?.promosi_gambar_tambahan.length > 0 ? (
            <Carousel>
              <CarouselContent>
