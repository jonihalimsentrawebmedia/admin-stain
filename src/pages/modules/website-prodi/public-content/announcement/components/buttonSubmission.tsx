...
export const ButtonSubmissionAnnouncementProdi = (data: IAnnouncement) => {
  ...
  const HandleSubmission = async () => {
    setLoading(true)
    await AxiosClient.patch(`/prodi/pengumuman/${data?.id_pengumuman}/status-publish`, {
