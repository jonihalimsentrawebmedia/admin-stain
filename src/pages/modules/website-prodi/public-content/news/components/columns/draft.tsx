...
import { ButtonDeleteNewsProdi } from '../../components/buttonDelete.tsx'
import { ButtonSubmissionNewsProdi } from '../../components/buttonSubmission.tsx'
        ...
        return (
          <div className={'flex items-center gap-2 flex-col'}>
            <div className={'flex items-center gap-1'}>
              ...
              <ButtonDeleteNewsProdi {...data} />
            </div>
            <ButtonSubmissionNewsProdi {...data} />
          </div>
        )
      },
    },
