...
import {
  UseGetLogNewsProdi,
  UseGetProdiNewsDetail,
} from '@/pages/modules/website-prodi/public-content/news/hooks'

export const LogActivityNewsProdiPage = () => {
  const { id } = useParams()
  const { logData } = UseGetLogNewsProdi(id ?? '')
