...
import { ButtonDeleteFileDownloadProdi } from '@/pages/modules/website-prodi/public-content/Download/components/buttonDelete.tsx'

export const DownloadFileProdiColumns = () => {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className={'flex items-center gap-1.5'}>
            ...
            <ButtonDeleteFileDownloadProdi data={data} />
          </div>
        )
      },
    },
