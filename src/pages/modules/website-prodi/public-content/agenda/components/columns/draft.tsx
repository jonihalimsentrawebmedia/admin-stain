...
import { ButtonDeleteAgendaProdi } from '../buttonDelete.tsx'
import { ButtonSubmissionAgendaProdi } from '../buttonSubmission.tsx'
        ...
        return (
          <>
            <div className={'flex flex-col gap-2 items-center'}>
              ...
              <ButtonSubmissionAgendaProdi {...row?.original} />
            </div>
          </>
        )
      },
