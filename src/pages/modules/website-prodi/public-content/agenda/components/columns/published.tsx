...
import { ButtonUnpublishAgendaProdi } from '../buttonUnpublish.tsx'
        ...
        return (
          <>
            {data?.is_content_website_utama ? (
              <p className={'text-primary font-semibold text-sm'}>Konten Website Utama</p>
            ) : (
              <ButtonUnpublishAgendaProdi {...row?.original} />
            )}
          </>
        )
      },
