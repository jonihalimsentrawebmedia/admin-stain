...
import { UseGetAgendaProdiStatus } from './hooks/index'
import ButtonTitleGroup from '@/components/common/button/ButtonTitleGroup.tsx'
import { TabsListCustom } from '@/pages/modules/website-utama/public-content/slider/components/tabsList.tsx'
import { TableDataListAgenda } from '@/pages/modules/website-prodi/public-content/agenda/components/AgendaList.tsx'

export const AgendaProdiPublicContent = () => {
  const navigate = useNavigate()
  const { status } = UseGetAgendaProdiStatus()
  ...
  const DataTabs = [
    {
      ...
      value: 'DRAFT',
      element: <TableDataListAgenda status={statusParams ?? 'DRAFT'} />,
    },
    {
      id: 2,
      name: (
