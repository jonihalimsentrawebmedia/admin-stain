...
import { UseGetAgendaProdiDetail } from '../hooks/index'
import ButtonTitleGroup from '@/components/common/button/ButtonTitleGroup.tsx'
import { Button } from '@/components/ui/button.tsx'
import { HiPencil } from 'react-icons/hi'
import { Separator } from '@/components/ui/separator.tsx'
import { format } from 'date-fns'
import { ButtonSubmissionAgendaProdi } from '@/pages/modules/website-prodi/public-content/agenda/components/buttonSubmission.tsx'
import type { IAgendaDetail } from '@/pages/modules/website-utama/public-content/agenda/data'

export const AgendaProdiDetailPage = () => {
  const { id } = useParams()
  const { agendaProdiDetail: detail } = UseGetAgendaProdiDetail(id ?? '')
            ...
            },
            {
              ...
              element:
                detail?.status_publish === 'DRAFT' ? (
                  <ButtonSubmissionAgendaProdi {...(detail as IAgendaDetail)} />
                ) : (
                  <></>
                ),
            },
