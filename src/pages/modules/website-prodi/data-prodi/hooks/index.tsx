...
export const UseGetDetailDataProdi = (props?: Props) => {
  ...
  const { data, isLoading, isFetching } = useQuery<IDetailUniversity>({
    queryKey: ['data-prodi', ParamsSearch.toString()],
    refetchOnWindowFocus: false,
    queryFn: () => AxiosClient.get(`/prodi/profil?${ParamsSearch}`).then((res) => res.data?.data),
  })

  const loading = isLoading || isFetching

  return { dataProdi: data, loading }
}
