...
import { UseGetProfileContactUs } from '@/pages/modules/website-prodi/profile/contact-us/hooks'
import {
  ContactUsResolver,
...
const ContactUsProfilePage = () => {
  ...
  const handleSave = async (e: IContactUsTypeForm) => {
    setLoading(true)
    await AxiosClient.post(`prodi/profil/hubungi-kami`, {
      ...e,
    })
      .then((res) => {
        if (res.data.status) {
...
export default ContactUsProfilePage
