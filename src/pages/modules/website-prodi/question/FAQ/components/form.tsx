...
import { UseGetFaqCategoryProdi } from '../category/hooks/index'
...
export const FormFAQDataProdi = (props: Props) => {
  const { form, loading, open, setOpen, HandleSave } = props
  const { loading: load1, categoryFaq } = UseGetFaqCategoryProdi({ isGetAll: true })
