...
import { ButtonEditAlbumProdi } from '@/pages/modules/website-prodi/gallery/album/components/buttonEdit.tsx'
import { ButtonDeleteAlbumPhotoProdi } from '@/pages/modules/website-prodi/gallery/album/components/buttonDelete.tsx'

export const ColumnsGalleryAlbumProdi = () => {
      ...
      cell: ({ row }) => {
        return (
          <div className={'flex justify-end gap-2 items-center'}>
            <ButtonEditAlbumProdi data={row?.original} />
            <ButtonDeleteAlbumPhotoProdi {...row?.original} />
          </div>
        )
      },
    },
