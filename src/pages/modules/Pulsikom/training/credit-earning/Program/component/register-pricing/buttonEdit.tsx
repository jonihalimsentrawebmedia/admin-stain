...
import { ResolverPricing, type TResolverPricing } from '../../data/resolver.tsx'
import { zodResolver } from '@hookform/resolvers/zod'
import AxiosClient from '@/provider/axios.tsx'
import { toast } from 'react-toastify'
import { DialogBasic } from '@/components/common/dialog/dialogBasic.tsx'
import { useQueryClient } from '@tanstack/react-query'
import { FormRegisterPricing } from '../form/formRegisterPricing.tsx'
...
export const ButtonEditRegisterPricing = (props: Props) => {
  ...
  const HandleSave = async (value: TResolverPricing) => {
    ...
    await AxiosClient.put(
      `/pusilkom/program/${id}/biaya-pendaftaran/${data?.id_biaya_pendaftaran}`,
      value
    )
      .then((res) => {
        if (res.data.status) {
