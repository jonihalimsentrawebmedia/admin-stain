...
import { ResolverTopicSchedule, type TResolverTopicSchedule } from '../../data/resolver'
import { zodResolver } from '@hookform/resolvers/zod'
import AxiosClient from '@/provider/axios.tsx'
import { toast } from 'react-toastify'
import { DialogBasic } from '@/components/common/dialog/dialogBasic.tsx'
import { FormTopicAndSchedule } from '../form/formTopic.tsx'
...
export const ButtonAddTopicSchedule = () => {
  ...
  const HandleSave = async (value: TResolverTopicSchedule) => {
    setLoading(true)
    await AxiosClient.post(`/pusilkom/program/${id}/bahasan-dan-topik`, {
      ...value,
