...
import type { IProgramList } from './types'
...
import { ButtonPublish } from '../component/buttonPublish.tsx'
import { ButtonDeleteProgram } from '../component/buttonDelete.tsx'
import { ButtonCloseProgram } from '../component/buttonClose.tsx'

export const ColumnsListProgram = () => {
...
export const ColumnsPublishProgram = () => {
  const [searchParams] = useSearchParams()
  const page = Number(searchParams.get('page') ?? '1')
  const limit = Number(searchParams.get('limit') ?? '10')
...
export const ColumnsClosedProgram = () => {
  const [searchParams] = useSearchParams()
  const page = Number(searchParams.get('page') ?? '1')
  const limit = Number(searchParams.get('limit') ?? '10')
