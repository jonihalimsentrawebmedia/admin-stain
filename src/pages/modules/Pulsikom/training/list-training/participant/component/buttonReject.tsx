...
export const ButtonReject = (props: props) => {
  ...
  const HandleCancel = async (value: any) => {
    ...
    await AxiosClient.patch(
      `/pusilkom/training/${data?.id_training}/peserta/${data?.id_peserta}/tolak`,
      {
  ...
  return (
    <>
      {is_icon ? (
        <button className={'p-1.5 bg-red-500 rounded text-white'} onClick={() => setOpen(true)}>
      ...
      <DialogBasic
        ...
        title={<p className={'text-red-500 text-xl font-semibold'}>Tolak Pendaftar</p>}
        description={
          'Apakah anda yakin untuk menolak pendaftar berikut? Mohon tuliskan alasan penolakan'
        }
      >
