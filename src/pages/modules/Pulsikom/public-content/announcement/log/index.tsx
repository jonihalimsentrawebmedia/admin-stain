...
import { UseGetLogAnnouncementPulsikom, UseGetPulsikomAnnouncementDetail } from '../hooks/index'

export const LogActivityAnnouncementPulsikom = () => {
  const { id } = useParams()
  const columns = ColumnsLog()
  const { logData } = UseGetLogAnnouncementPulsikom(id ?? '')
