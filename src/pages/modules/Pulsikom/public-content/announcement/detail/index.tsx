...
import { UseGetPulsikomAnnouncementDetail } from '../hooks/index'
...
export const AnnouncementPulsikomDetailPage = () => {
  const { id } = useParams()
  const { detail } = UseGetPulsikomAnnouncementDetail(id ?? '')
              ...
              element: (
                <div className={'flex items-center gap-2'}>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      navigate(
                        `/modules/pulsikom/public-content/announcement/edit/${detail?.id_pengumuman}`
                      )
                    }
