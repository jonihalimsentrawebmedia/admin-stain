...
export const ButtonSubmissionAgendaUnit = (data: IAgendaDetail) => {
  ...
  const HandleSubmission = async () => {
    setLoading(true)
    await AxiosClient.patch(`/pusilkom/agenda/${data?.id_agenda}/status-publish`, {
