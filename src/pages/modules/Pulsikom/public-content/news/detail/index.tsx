...
export const DetailNewsPulsikomPage = () => {
  const { id } = useParams()
  ...
  const temp = [detail?.gambar, ...images.map((item) => item.gambar)]
        ...
        buttonGroup={[
          {
            ...
            element: (
              <div className={'flex items-center gap-2'}>
                ...
                <Button
                  onClick={() =>
                    navigate(`/modules/pulsikom/public-content/news/edit/${detail?.id_berita}`)
                  }
