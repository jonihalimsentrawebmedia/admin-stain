...
import { UseGetCategoryDownloadPulsikom, UseGetDownloadPulsikom } from './hooks/index'
import { DownloadFileCarrierColumns } from './data/columns'
import { Button } from '@/components/ui/button.tsx'
import { IoList } from 'react-icons/io5'
import ButtonGoToGuide from '@/pages/modules/website-utama/panduan/components/ButtonGoToGuide'

const DownloadFilePulsikom = () => {
  const navigate = useNavigate()
  const { categoryDownload, meta: metaCategory, loading: load1 } = UseGetCategoryDownloadPulsikom()
  const { downloadUnit, meta, loading: load2 } = UseGetDownloadPulsikom()
          ...
          buttonGroup={[
             {
              ...
              element: (
                <ButtonGoToGuide
                  ...
                  valueGuide="PUSILKOM_KONTEN_PUBLIK_DOWNLOAD"
                />
              ),
            },
            {
...
export default DownloadFilePulsikom
