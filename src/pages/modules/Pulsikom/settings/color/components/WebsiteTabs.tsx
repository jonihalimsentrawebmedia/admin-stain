...
import { UseGetColorAdminPulsikom } from '../hooks/index.tsx'
...
const WebsiteTabs = () => {
  ...
  const { color } = UseGetColorAdminPulsikom('public')
  ...
  const HandleSave = async (e: any) => {
    setLoading(true)
    await AxiosClient.post('/pusilkom/pengaturan-warna/public', {
      ...
      .then((res) => {
        if (res.data.status) {
          ...
          queryClient.invalidateQueries({
            queryKey: ['color-public-pusilkom'],
          })
        }
      })
      .catch((err) => {
