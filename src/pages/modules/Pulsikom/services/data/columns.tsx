...
import { ButtonDeleteServices } from '@/pages/modules/Pulsikom/services/component/buttonDelete.tsx'
...
export const ColumnsService = () => {
  ...
  const columns: ColumnDef<IServices>[] = [
    ...
    },
    {
      ...
      header: 'Deskripsi',
      cell: ({ row }) => {
        return <RenderHTMLContent content={row?.original?.deskripsi_singkat} />
      },
    },
    {
      accessorKey: 'action',
