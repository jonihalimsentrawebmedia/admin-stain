...
export const ButtonSubmissionAnnouncementFaculty = (data: IAnnouncement) => {
  ...
  const HandleSubmission = async () => {
    setLoading(true)
    await AxiosClient.patch(`/spi/pengumuman/${data?.id_pengumuman}/status-publish`, {
