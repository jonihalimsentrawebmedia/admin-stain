      ...
      <div className="flex flex-col gap-5">
        <ButtonTitleGroup
          ...
          buttonGroup={[
            {
              type: 'custom',
              element: <ButtonGoToGuide titleGuide={'Konten Publik - Berita'} valueGuide="SPI_KONTEN_PUBLIK_BERITA" />,
            },
