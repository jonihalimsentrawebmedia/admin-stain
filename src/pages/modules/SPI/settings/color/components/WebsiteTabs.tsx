...
import { UseGetColorAdminSPI } from '../hooks/index.tsx'
...
const WebsiteTabs = () => {
  ...
  const { color } = UseGetColorAdminSPI('public')
  ...
  const HandleSave = async (e: any) => {
    setLoading(true)
    await AxiosClient.post('/spi/pengaturan-warna/public', {
