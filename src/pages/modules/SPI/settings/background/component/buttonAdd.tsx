...
import { SPIMENU } from '../data/constanta.tsx'
...
const ButtonAddBackground = () => {
  ...
  const HandleSave = async (value: any) => {
    setLoading(true)
    await AxiosClient.post(`/spi/background/${context}`, {
      url_gambar: value.gambar_url,
    })
      .then((res) => {
        if (res.data.status) {
          setOpen(false)
...
export default ButtonAddBackground
