...
import { UseGetChangeDataProfile } from '@/pages/modules/manajeman-editor/controller/useGetChangeDataProfile.tsx'

const UniversityDetailViewModel = () => {
  const { id } = useParams()
  ...
  const fieldAddress1 = [
    ...
    },
    {
      ...
      name: 'current_profil.kelurahan_desa',
    },
    {
      label: 'Kode Pos',
  ...
  function goToEdit() {
    navigate(`/modules/editor/data-university/edit/${id}`)
  }
  useEffect(() => {
...
export default UniversityDetailViewModel
