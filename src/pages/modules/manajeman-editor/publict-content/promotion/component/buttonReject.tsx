...
import type { IPromotion } from '@/pages/modules/manajeman-editor/publict-content/promotion/data/types'
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
export const ButtonRejectAgendaManagementEditor = (data: IPromotion) => {
