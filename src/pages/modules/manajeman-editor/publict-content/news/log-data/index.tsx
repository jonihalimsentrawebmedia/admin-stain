...
import { UseGetLogNewsManagementEditor, UseGetManagementEditorNewsDetail } from '../hooks/index.tsx'

export const LogActivityNewsManagementEditorPage = () => {
  const { id } = useParams()
  const { logData } = UseGetLogNewsManagementEditor(id ?? '')
