...
import { UseGetArticleManagementEditorDetail, UseGetLogArticleEditor } from '../hooks'

export const LogActivityArticleManagementEditorPage = () => {
  const { id } = useParams()
  const { logData, loading, meta } = UseGetLogArticleEditor(id ?? '')
