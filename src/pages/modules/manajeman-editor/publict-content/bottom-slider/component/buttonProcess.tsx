...
const ButtonProcessManagementEditor = (data: IListBottomSlider) => {
  ...
  return (
    <>
      ...
      <DialogCustom
        ...
        setOpen={setOpen}
        title={'Proses Slider Bawah'}
        description={'Apakah anda yakin untuk memproses slider bawah yang dipilih?'}
      >
