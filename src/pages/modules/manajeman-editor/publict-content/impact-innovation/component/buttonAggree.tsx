...
const ButtonAgreeManagementEditor = (data: IImpactInnovationList) => {
  ...
  return (
    <>
      ...
      <DialogCustom
        ...
        setOpen={setOpen}
        title={'Setujui Inovasi Berdampak'}
        description={'Apakah anda yakin untuk menyetujui inovasi berdampak?'}
      >
