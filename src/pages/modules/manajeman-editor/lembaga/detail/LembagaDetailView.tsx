...
import LembagaDetailViewModel from './LembagaDetailViewModel.tsx'
  ...
  return (
    <div className="flex flex-col gap-4">
      <ButtonTitleGroup
        ...
        buttonGroup={[
           {
            ...
            element: (
              <ButtonGoToGuide
                titleGuide={`Pengajuan Data - Profil Lembaga`}
        ...
        label="Pengajuan Data - Profil Lembaga"
      />
      <div className="flex flex-col gap-4">
...
export default LembagaDetailView
