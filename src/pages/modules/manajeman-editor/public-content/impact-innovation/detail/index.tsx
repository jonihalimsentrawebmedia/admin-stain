...
import { ButtonSubmissionImpactInnovation } from '../components/buttonSubmission'
            ...
            element: (
              <div className={'flex items-center gap-2'}>
                ...
                <Button
                  onClick={() =>
                    navigate(
                      `/modules/editor/public-content/impact-innovation/edit/${detail?.id_inovasi_berdampak}`
                    )
                  }
