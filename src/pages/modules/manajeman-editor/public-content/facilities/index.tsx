...
import TableListFacilities from './components/TableListFacilities.tsx'
import { UseGetFacilitiesStatus } from './hooks/index.tsx'
  ...
  const DataTabs = [
    {
      ...
      value: 'DRAFT',
      element: <TableListFacilities status={statusParams ?? 'DRAFT'} />,
    },
    {
      id: 2,
      name: (
  ...
  return (
    <>
      <div className="flex flex-col gap-5">
        <ButtonTitleGroup label={'Fasilitas'} buttonGroup={[]} />
