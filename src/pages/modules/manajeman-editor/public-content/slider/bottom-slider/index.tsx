...
import { UseGetStatusBottomSlider } from './hooks'
import type { StatusPublish } from '@/pages/modules/website-prodi/public-content/news/data/types'
import SliderBottomList from './components/SliderBottomList'
  ...
  const DataTabs = [
    {
      ...
      value: 'DRAFT',
      element: <SliderBottomList status={statusParams ?? 'DRAFT'} />,
    },
    {
      id: 2,
      name: (
  ...
  return (
    <>
      <div className="flex flex-col gap-5">
        <ButtonTitleGroup label={'Slider Bawah'} buttonGroup={[]} />
