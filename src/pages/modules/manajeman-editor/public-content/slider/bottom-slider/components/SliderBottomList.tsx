...
import { UseGetListBottomSlider } from '../hooks'
...
const SliderBottomList = (props: Props) => {
  const { status } = props
  ...
  const { loading, meta, listBottomSlider } = UseGetListBottomSlider({
...
export default SliderBottomList
