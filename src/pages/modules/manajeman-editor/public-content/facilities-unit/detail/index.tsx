...
import { ButtonSubmissionFacilities } from '../components/buttonSubmission'
              ...
              element: (
                <div className={'flex items-center gap-2'}>
                  ...
                  <Button
                    onClick={() =>
                      navigate(
                        `/modules/editor/public-content/facilities-unit/edit/${detail?.id_unit_fasilitas}`
                      )
                    }
            ...
            },
            {
              ...
              element:
                detail?.status_publish === 'DRAFT' ? (
                  <ButtonSubmissionFacilities {...(detail as any)} />
                ) : (
                  <></>
                ),
            },
