...
import { FacilitiesUnitResolver, type FacilitiesUnitResolverType } from '@/pages/modules/website-unit/public-content/Facilities/data/resolver'
import { UseGetFacilitiesUnitDetail } from '../hooks'
import { FormFacilitiesUnit } from '../components/form'
    ...
    await AxiosClient.put(`/editor/unit-fasilitas/${id}`, e)
      .then((res) => {
        if (res.data.status) {
          ...
          navigate('/modules/editor/public-content/facilities-unit')
        }
      })
      .catch((err) => {
        setLoading(false)
