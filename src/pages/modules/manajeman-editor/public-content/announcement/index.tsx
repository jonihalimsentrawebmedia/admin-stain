...
import { UseGetManagementEditorAnnouncementStatus } from './hooks/index'
import ButtonTitleGroup from '@/components/common/button/ButtonTitleGroup.tsx'
import { TabsListCustom } from '@/pages/modules/website-utama/public-content/slider/components/tabsList.tsx'
import { TableDataListAnnouncement } from './components/listAnnouncement'

export const AnnouncementManagementEditorPublicContent = () => {
  const { status } = UseGetManagementEditorAnnouncementStatus()
  ...
  return (
    <>
      <div className="flex flex-col gap-5">
        <ButtonTitleGroup label={'Pengumuman'} buttonGroup={[]} />
