...
export const ButtonSubmissionAnnouncementManagementEditor = (data: IAnnouncement) => {
  ...
  const HandleSubmission = async () => {
    setLoading(true)
    await AxiosClient.patch(`/management-editor/pengumuman/${data?.id_pengumuman}/status-publish`, {
