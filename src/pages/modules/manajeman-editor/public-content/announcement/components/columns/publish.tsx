...
import { ButtonAnnouncementUnpublishManagementEditor, } from '../buttonUnpublish.tsx'
  ...
  const columns: ColumnDef<IAnnouncement>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        return (
          <>
            <ButtonAnnouncementUnpublishManagementEditor {...row?.original} />
          </>
        )
      },
    },
