...
import { UseGetPromotionEditorStatus } from './hooks'
import { TableDataListPromotion } from './components/listPromotion'

export const PromotionManagementEditorPage = () => {

  const { status } = UseGetPromotionEditorStatus()
  ...
  const DataTabs = [
    {
      ...
      value: 'DRAFT',
      element: <TableDataListPromotion status={statusParams ?? 'DRAFT'} />,
    },
    {
      id: 2,
      name: (
  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        <ButtonTitleGroup label={'Promosi'} buttonGroup={[]} />
