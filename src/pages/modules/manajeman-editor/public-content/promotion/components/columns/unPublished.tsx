...
import { ButtonPublishPromotionManagementEditor } from '../buttonPublish'
      ...
      cell: ({ row }) => {
        return (
          <div className={'flex flex-col gap-1.5 items-center'}>
            <Link to={`edit/${row?.original?.id_promosi}`}>
              <Button
                size={'sm'}
                variant={'outline'}
            ...
            <ButtonPublishPromotionManagementEditor {...row?.original} />
          </div>
        )
      },
    },
