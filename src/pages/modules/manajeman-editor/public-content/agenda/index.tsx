...
import { UseGetAgendaManagementEditorStatus } from './hooks'
import { TableDataListAgenda } from './components/AgendaList'

export const AgendaManagementEditorPublicContent = () => {

  const { status } = UseGetAgendaManagementEditorStatus()
  ...
  return (
    <>
      <div className="flex flex-col gap-5">
        <ButtonTitleGroup label={'Agenda'} buttonGroup={[]} />
