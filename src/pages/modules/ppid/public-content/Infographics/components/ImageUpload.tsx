              ...
              <div>
                {loading ? (
                  ...
                  <div className="flex flex-col gap-2 justify-center items-center">
                    <img src={preview} className="w-full object-cover h-[200px] " alt="" />
                    <Button
                      onClick={(e) => {
                        handleClick(e)
                      }}
                  ...
                  >
                    <div className="border flex flex-col gap-2 items-center justify-center text-primary h-[200px] px-4 py-2 w-full  rounded border-[#70F2B1]   bg-[#F5FFFA]">
                      <MdAddPhotoAlternate size={32} />
                      Upload Gambar
                      <br />
                      <span className="text-xs text-[#444]">Max {maxSizeMB} MB</span>
                      <span className="text-xs text-[#444]">PNG, JPG, JPEG</span>
                    </div>
                  </div>
                )}
              </div>
