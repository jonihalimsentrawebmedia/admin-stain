...
const useGetInformationAvailableDocument = (props: Props) => {
  ...
  const { data, isLoading, isFetching } = useQuery<{
    ...
    queryKey: ['information-available-ppip-document', ParamsSearch.toString()],
    queryFn: () =>
      AxiosClient.get(`/unit-ppid/informasi-tersedia-dokumen?${ParamsSearch}`).then(
        (res) => res.data
      ),
  })
...
export default useGetInformationAvailableDocument
