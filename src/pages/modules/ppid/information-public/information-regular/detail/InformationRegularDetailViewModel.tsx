...
const InformationRegularDetailViewModel = () => {
        ...
        return (
          <div className="flex gap-2 items-center">
            <ButtonEditDocument
              ...
              linkPost={`/unit-ppid/informasi-berkala-dokumen/${values.id_daftar_dokumen}`}
              data={values}
            />
            <ButtonDeleteDocument
              titleField={searchParams.get('title') || ''}
              title="Dokumen"
              keyLinkDelete="information-regular-ppip-document"
              linkDelete={`/unit-ppid/informasi-berkala-dokumen/${values.id_daftar_dokumen}`}
              data={values}
            />
          </div>
        )
...
export default InformationRegularDetailViewModel
