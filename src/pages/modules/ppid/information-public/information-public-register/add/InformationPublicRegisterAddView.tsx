...
const InformationPublicRegisterAddView = () => {
  ...
  async function handleSave(data: InformationPublicRegisterType) {
    setLoading(true)
    try {
      const res = await AxiosClient.post(`/unit-ppid/daftar-informasi-public`, {
        ...data,
      })
...
export default InformationPublicRegisterAddView
