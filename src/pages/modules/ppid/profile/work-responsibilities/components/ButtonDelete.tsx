...
const ButtonDelete = ({ data }: Props) => {
  ...
  const field = [
    ...
    },
    {
      name: 'isi',
      label: 'Isi',
      component: <div dangerouslySetInnerHTML={{ __html: data.isi }} />,
    },
  ]
  async function handleDelete() {
    setLoading(true)
    try {
      const res = await AxiosClient.delete(`/unit-ppid/tugas-fungsi-tanggung-jawab/${data.id_tugas_fungsi_tanggung_jawab}`)
  ...
  return (
    <>
      ...
      <DialogCustom
        ...
        open={open}
        setOpen={setOpen}
        title={<p className="text-2xl text-red-500">Hapus Konten Tugas, Fungsi, & Tanggung Jawab</p>}
