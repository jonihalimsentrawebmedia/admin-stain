import { type Status, UseGetVerificationJobSeeker } from './hooks/index'
import { useState } from 'react'
import {
  ColumnsRejectJobSeeker,
  ColumnsRevisionJobSeeker,
  ColumnsVerificationJobSeeker,
} from './data/columns'
...
export const JobSeekerUserVerification = () => {
  const [status, setStatus] = useState<Status>('PENDING')
  const { verification, loading: loadVerification } = UseGetVerificationJobSeeker({
    status: status,
  })

  const columns = ColumnsVerificationJobSeeker()
  const columnsRevision = ColumnsRevisionJobSeeker()
  const columnsReject = ColumnsRejectJobSeeker()
    ...
    },
    {
      ...
      element: (
        <>
          ...
          <TableBasic
            columns={columnsRevision as any}
            data={verification as any}
            loading={loadVerification}
            rowIdKey={'id_pencari_kerja'}
            onSelectedRowsChange={setCollectId}
