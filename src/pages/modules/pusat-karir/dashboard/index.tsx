...
export default function DashboardCarrierCenter() {
  ...
  const actions = [
    { label: 'Tulis Berita', url: '/modules/pusat-karir/public-content/news/add' },
    { label: 'Tulis Agenda', url: '/modules/pusat-karir/public-content/agenda/add' },
    { label: 'Tulis Artikel', url: '/modules/pusat-karir/public-content/article/add' },
  ]
