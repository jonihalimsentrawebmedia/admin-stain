...
import { UseGetColorAdminCarrier } from '../hooks/index.tsx'
...
const WebsiteTabs = () => {
  ...
  const { color } = UseGetColorAdminCarrier('public')
  ...
  const HandleSave = async (e: any) => {
    setLoading(true)
    await AxiosClient.post('/pusat-karir/pengaturan-warna/public', {
