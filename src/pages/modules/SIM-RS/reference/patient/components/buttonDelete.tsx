...
export const ButtonDeletePatient = (props: Props) => {
  const { data } = props
  ...
  const HandleSave = async () => {
    setLoading(true)
    await AxiosClient.delete(`/simrs/referensi/pasien/${data?.id_pasien}`)
      .then((res) => {
        if (res.data.status) {
          toast.success(res.data.message || 'Berhasil menghapus data pasien')
