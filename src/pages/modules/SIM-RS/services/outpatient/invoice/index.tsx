  ...
  return (
    <div className="flex flex-col p-6 gap-6 min-h-[824px]">
      ...
      <div className="flex flex-col gap-4 w-full">
        ...
        <div className="w-full border border-gray-300 bg-white">
          ...
          {invoice.daftar_tagihan.map((item, index) => (
            <div
              key={index}
              className="flex flex-row items-center w-full h-[38px] border-b border-gray-300"
            >
      ...
      <div className="flex flex-col gap-4 w-full">
        ...
        <div className="w-fit border border-gray-300 bg-white rounded-lg">
          {/* Table Head */}
          <div className="flex flex-row items-center w-[542px] h-[38px] bg-primary border-b border-gray-300 rounded-t-lg">
            <div className="flex items-center justify-center flex-1 px-2 text-sm text-white">
          ...
          {invoice.ringkasan.detail_pembayaran.map((item, index) => (
            <div
              key={index}
              className="flex flex-row items-center w-[542px] h-[38px] border-b border-gray-300"
            >
              <div className="flex items-center justify-center flex-1 px-2 text-sm text-neutral">
