...
import { ButtonSubmissionFacilitiesUnit } from '../buttonSubmission.tsx'
          ...
          <>
            <div className={'flex flex-col gap-2 items-center'}>
              <div className="flex items-center gap-1">
                ...
                <Link to={`edit/${row?.original?.id_unit_fasilitas}`}>
                  <button className={'bg-yellow-500 p-1.5 rounded text-white hover:bg-yellow-600'}>
                    <HiPencil />
                  </button>
                </Link>
                <ButtonDeleteFacilitiesUnit {...row?.original} />
              </div>
              <ButtonSubmissionFacilitiesUnit {...row?.original} />
            </div>
          </>
        )
      },
