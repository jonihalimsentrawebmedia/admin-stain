...
import { UseGetLogFacilitiesUnit, UseGetFacilitiesUnitDetail } from '../hooks/index'

export const LogActivityFacilitiesUnitPage = () => {
  const { id } = useParams()
  const { logData } = UseGetLogFacilitiesUnit(id ?? '')
    ...
    <>
      ...
      <div className={'flex items-start gap-x-8 mt-5'}>
        ...
        <div className={'flex flex-col gap-y-2 text-sm'}>
          ...
          <p className="text-gray-500">Nama Deskripsi</p>
