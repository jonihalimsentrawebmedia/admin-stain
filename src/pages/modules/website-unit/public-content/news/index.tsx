          ...
          buttonGroup={[
            {
              type: 'custom',
              element: (
                <ButtonGoToGuide titleGuide="Konten Publik - Berita" valueGuide="PERPUSTAKAAN_KONTEN_PUBLIK_BERITA" />
              ),
            },
