...
import { ButtonDeleteAgendaUnit } from '../buttonDelete.tsx'
import { ButtonSubmissionAgendaUnit } from '../buttonSubmission.tsx'
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <img
          ...
          alt="gambar"
          className={'min-w-[150px] w-[150px] object-cover h-[200px] rounded'}
        />
      ),
    },
    {
          ...
          <>
            <div className={'flex flex-col gap-2 items-center'}>
              <div className="flex items-center gap-1">
                ...
                <ButtonDeleteAgendaUnit {...row?.original} />
              </div>
              <ButtonSubmissionAgendaUnit {...row?.original} />
            </div>
          </>
        )
      },
