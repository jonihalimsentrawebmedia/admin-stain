...
import { UseGetUnitAnnouncementDetail, UseGetLogAnnouncementUnit } from '../hooks/index'

export const LogActivityAnnouncementUnitPage = () => {
  const { id } = useParams()
  const columns = ColumnsLog()
  const { logData } = UseGetLogAnnouncementUnit(id ?? '')
