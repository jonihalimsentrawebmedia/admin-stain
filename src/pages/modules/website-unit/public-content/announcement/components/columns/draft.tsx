...
import { ButtonDeleteAnnouncementUnit } from '../buttonDelete.tsx'
import { ButtonSubmissionAnnouncementUnit } from '../buttonSubmission.tsx'
        ...
        return (
          <>
            <div className={'flex flex-col gap-2 items-center'}>
              ...
              <ButtonSubmissionAnnouncementUnit {...row?.original} />
            </div>
          </>
        )
      },
