...
import { UseGetUnitAnnouncementStatus } from './hooks/index'
import ButtonTitleGroup from '@/components/common/button/ButtonTitleGroup.tsx'
import { TabsListCustom } from '@/pages/modules/website-utama/public-content/slider/components/tabsList.tsx'
import { TableDataListAnnouncementUnit } from './components/listAnnouncement'
import ButtonGoToGuide from '@/pages/modules/website-utama/panduan/components/ButtonGoToGuide'

export const AnnouncementUnitPublicContent = () => {
  const navigate = useNavigate()
  const { status } = UseGetUnitAnnouncementStatus()
  ...
  const DataTabs = [
    {
      ...
      value: 'DRAFT',
      element: <TableDataListAnnouncementUnit status={statusParams ?? 'DRAFT'} />,
    },
    {
      id: 2,
      name: (
          ...
          buttonGroup={[
            {
              ...
              element: (
                <ButtonGoToGuide
                  ...
                  valueGuide="PERPUSTAKAAN_KONTEN_PUBLIK_PENGUMUMAN"
                />
              ),
            },
