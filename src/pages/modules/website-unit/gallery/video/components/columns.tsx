...
import { ButtonEditVideoUnit } from './buttonEdit'
import { ButtonDeleteVideoUnit } from './buttonDelete.tsx'

export const ColumnsVideoUnit = () => {
      ...
      cell: ({ row }) => {
        return (
          <div className={'flex justify-end gap-2 items-center'}>
            <ButtonEditVideoUnit data={row.original} />
            <ButtonDeleteVideoUnit {...row?.original} />
          </div>
        )
      },
    },
