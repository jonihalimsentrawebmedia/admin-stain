...
export const UseGetFaqCategoryUnit = (props?: Props) => {
  ...
  const { data, isLoading, isFetching } = useQuery<{ data: ICategoryFAQ[]; meta: Meta }>({
    queryKey: ['unit-category-faq', ParamsSearch.toString()],
    refetchOnWindowFocus: false,
    queryFn: () => AxiosClient.get(`/unit/kategori-faq?${ParamsSearch}`).then((res) => res.data),
  })
