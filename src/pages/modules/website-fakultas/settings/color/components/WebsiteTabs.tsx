...
import { UseGetColorAdminFaculty } from '../hooks/index.tsx'
...
const WebsiteTabs = () => {
  ...
  const { color } = UseGetColorAdminFaculty('public')
  ...
  const HandleSave = async (e: any) => {
    setLoading(true)
    await AxiosClient.post('/fakultas/pengaturan-warna/public', {
