...
import { UseGetCategoryDownloadFaculty, UseGetDownloadFaculty } from './hooks/index'
...
const DownloadFileFacultyPage = () => {
  ...
  const { categoryDownload, meta: metaCategory, loading: load1 } = UseGetCategoryDownloadFaculty()
  const { downloadUnit, meta, loading: load2 } = UseGetDownloadFaculty()
...
export default DownloadFileFacultyPage
