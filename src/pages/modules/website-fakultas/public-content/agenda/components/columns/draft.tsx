...
import { ButtonDeleteAgendaFaculty } from '../buttonDelete.tsx'
import { ButtonSubmissionAgendaFaculty } from '../buttonSubmission.tsx'
          ...
          <>
            <div className={'flex flex-col gap-2 items-center'}>
              <div className="flex items-center gap-1">
                ...
                <ButtonDeleteAgendaFaculty {...row?.original} />
              </div>
              <ButtonSubmissionAgendaFaculty {...row?.original} />
            </div>
          </>
        )
      },
