...
import { UseGetAgendaFacultyDetail, UseGetLogAgendaFaculty } from '../hooks/index'

export const LogActivityAgendaFacultyPage = () => {
  const { id } = useParams()
  const columns = ColumnsLog()
  const { logData } = UseGetLogAgendaFaculty(id ?? '')
