...
import { UseGetAgendaFacultyDetail } from '../hooks/index'
import ButtonTitleGroup from '@/components/common/button/ButtonTitleGroup.tsx'
import { Button } from '@/components/ui/button.tsx'
import { HiPencil } from 'react-icons/hi'
import { Separator } from '@/components/ui/separator.tsx'
import { format } from 'date-fns'
import { ButtonSubmissionAgendaFaculty } from '../components/buttonSubmission'
import type { IAgendaDetail } from '@/pages/modules/website-utama/public-content/agenda/data'

export const AgendaFacultyDetailPage = () => {
  const { id } = useParams()
  const { agendaUnitDetail: detail } = UseGetAgendaFacultyDetail(id ?? '')
              ...
              element: (
                <div className={'flex items-center gap-2'}>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      navigate(
                        `/modules/website-fakultas/public-content/agenda/edit/${detail?.id_agenda}`
                      )
                    }
            ...
            },
            {
              ...
              element:
                detail?.status_publish === 'DRAFT' ? (
                  <ButtonSubmissionAgendaFaculty {...(detail as IAgendaDetail)} />
                ) : (
                  <></>
                ),
            },
