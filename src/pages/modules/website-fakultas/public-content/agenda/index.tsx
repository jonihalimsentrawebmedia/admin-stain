...
import { UseGetAgendaFacultyStatus } from './hooks/index'
import ButtonTitleGroup from '@/components/common/button/ButtonTitleGroup.tsx'
import { TabsListCustom } from '@/pages/modules/website-utama/public-content/slider/components/tabsList.tsx'
import { TableDataListAgenda } from './components/AgendaList'
import ButtonGoToGuide from '@/pages/modules/website-utama/panduan/components/ButtonGoToGuide'

export const AgendaFacultyPublicContent = () => {
  const navigate = useNavigate()
  const { status } = UseGetAgendaFacultyStatus()
          ...
          buttonGroup={[
            {
              ...
              element: (
                <ButtonGoToGuide
                  ...
                  valueGuide="FAKULTAS_KONTEN_PUBLIK_AGENDA"
                />
              ),
            },
