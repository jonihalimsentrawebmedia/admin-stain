...
import { UseGetFacultyAnnouncementDetail } from '../hooks/index'
import type { IAnnouncement } from '@/pages/modules/website-utama/public-content/announcement/data'
import { ButtonSubmissionAnnouncementFaculty } from '../components/buttonSubmission'

export const AnnouncementFacultyDetailPage = () => {
  const { id } = useParams()
  const { detail } = UseGetFacultyAnnouncementDetail(id ?? '')
              ...
              element: (
                <div className={'flex items-center gap-2'}>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      navigate(
                        `/modules/website-fakultas/public-content/announcement/edit/${detail?.id_pengumuman}`
                      )
                    }
            ...
            },
            {
              ...
              element:
                detail?.status_publish === 'DRAFT' ? (
                  <ButtonSubmissionAnnouncementFaculty {...(detail as IAnnouncement)} />
                ) : (
                  <></>
                ),
            },
