...
import { UseGetFacultyAnnouncementDetail, UseGetLogAnnouncementFaculty } from '../hooks/index'

export const LogActivityAnnouncementFaculty = () => {
  const { id } = useParams()
  const columns = ColumnsLog()
  const { logData } = UseGetLogAnnouncementFaculty(id ?? '')
