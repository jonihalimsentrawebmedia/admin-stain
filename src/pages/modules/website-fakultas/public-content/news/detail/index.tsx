...
import { UseGetFacultyNewsDetail } from '../hooks/index'
import { ButtonSubmissionNewsUnit } from '../components/buttonSubmission'

export const DetailNewsFacultyPage = () => {
  const { id } = useParams()
  const { unitNewsDetail: detail } = UseGetFacultyNewsDetail(id ?? '')
      ...
      <ButtonTitleGroup
        ...
        buttonGroup={[
          ...
          },
          {
            ...
            label: 'Edit Data',
            onClick: () => {
              navigate(`/modules/website-fakultas/public-content/news/edit/${detail?.id_berita}`)
            },
            element:
