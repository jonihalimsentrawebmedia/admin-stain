    ...
    <>
      {loading ? (
        ...
        <>
          ...
          {carrierCenter?.status_publish == 'DIAJUKAN_EDITOR' && (
            <div
              className={'border border-blue-500 rounded flex flex-col sm:flex-row p-2 sm:w-fit items-start sm:items-center gap-1.5 mt-5'}
            >
              ...
              <button className={'text-blue-500 text-sm font-semibold'} onClick={() => setRealData(!realData)}>
                KLIK DISINI
              </button>
            </div>
          )}
          ...
          >
            <AccordionCustom name={'identity'} title={'Identitas Institusi'}>
              <div className={'grid grid-cols-1 lg:grid-cols-[12rem_1fr] gap-3 lg:gap-5'}>
