...
export const ButtonDeleteSectorCarrier = (props: Props) => {
  const { data } = props
    ...
    <>
      ...
      >
        <div className="grid grid-cols-[12rem_1fr]">
          <p className="text-gray-500">Nama Program Pendidikan*</p>
          <p>{data?.nama_sektor_pendidikan}</p>
          <p className="text-gray-500">Deskripsi Program Pendidikan*</p>
          <RenderHTMLContent content={data?.deskripsi_sektor_pendidikan} />
        </div>
