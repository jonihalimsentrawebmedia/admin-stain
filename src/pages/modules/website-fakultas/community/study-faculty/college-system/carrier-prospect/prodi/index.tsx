...
import ColumnsSectorCarrierProspect from './data/columns'

const ProdiSectorCarrier = () => {
  ...
  const { columns } = ColumnsSectorCarrierProspect()

  return (
    <div className="flex flex-col gap-4">
      <ButtonTitleGroup isBack buttonGroup={[]} label="Sektor Pekerjaan" />
      <TableCustom
        addFilter={
...
export default ProdiSectorCarrier
