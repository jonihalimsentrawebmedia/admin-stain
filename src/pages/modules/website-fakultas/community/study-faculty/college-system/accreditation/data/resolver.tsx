...
export const FacultyAccreditationResolver = z.object({
  gambar: z
  ...
  dokumen_sk_akreditas: z.string(),
  key_dokumen_sk_akreditas: z.string().optional().nullable(),
})

export type IAccreditationForm = z.infer<typeof FacultyAccreditationResolver>
