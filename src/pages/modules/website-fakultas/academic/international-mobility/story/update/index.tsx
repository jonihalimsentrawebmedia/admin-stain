import { UseGetStoryDetailInternationalMobility } from '../hooks/index.tsx'
...
export const UpdateStoryMobility = () => {
  const { id } = useParams()
  const { storyDetail } = UseGetStoryDetailInternationalMobility(id as string)
