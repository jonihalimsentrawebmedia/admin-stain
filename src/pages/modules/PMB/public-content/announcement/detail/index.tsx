...
import { ButtonSubmissionAnnouncementPMB } from '../components/buttonSubmission'

export const DetailAnnouncementPMB = () => {
  const { id } = useParams()
                ...
                <div className={'flex items-center gap-2'}>
                  ...
                  {detail?.status_publish !== 'PUBLISHED' && (
                    <Button
                      ...
                      onClick={() =>
                        navigate(
                          `/modules/pmb/public-content/announcement/edit/${detail?.id_pengumuman}`
                        )
                      }
            ...
            },
            {
              ...
              element:
                detail?.status_publish === 'DRAFT' ? (
                  <ButtonSubmissionAnnouncementPMB {...(detail as IAnnouncement)} />
                ) : (
                  <></>
                ),
            },
