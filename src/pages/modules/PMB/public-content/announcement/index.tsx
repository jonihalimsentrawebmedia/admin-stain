  ...
  const DataTabs = [
    {
      ...
      value: 'DRAFT',
      element: <TableDataListAnnouncement status={statusParams ?? 'DRAFT'} />,
    },
    {
      id: 2,
      name: (
  ...
  return (
    <>
      <div className="flex flex-col gap-5">
          ...
          buttonGroup={[
            {
              ...
              element: (
                <ButtonGoToGuide
                  titleGuide={'Konten Publik - Pengumuman PMB'}
                  valueGuide="PMB_KONTEN_PUBLIK_PENGUMUMAN"
                />
              ),
            },
        ...
        <TabsListCustom
          triggerClassName={
            'border-primary rounded-none data-[state=active]:bg-primary data-[state=active]:text-white text-primary'
          }
