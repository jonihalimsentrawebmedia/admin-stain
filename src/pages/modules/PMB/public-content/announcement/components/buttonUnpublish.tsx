...
export const ButtonAnnouncementUnpublishFaculty = (data: IAnnouncement) => {
  ...
  const HandleSubmission = async () => {
    setLoading(true)
    await AxiosClient.patch(`/pmb/pengumuman/${data?.id_pengumuman}/status-publish`, {
