...
export default function DashboardPMB() {
  ...
  const actions = [
    { label: 'Tambah Jalur Masuk', url: '/modules/pmb/entrance-pmb' },
    { label: 'Tulis Pengumuman', url: '/modules/pmb/public-content/announcement/add' },
    { label: 'Tulis FAQ', url: '/modules/pmb/faq' },
  ]
