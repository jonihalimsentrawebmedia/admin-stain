...
import { UseGetSessionPMB } from '@/pages/modules/PMB/session/hooks'
    ...
    <header className="py-3 px-3 sm:py-4 sm:px-5 bg-[#E9FFF1] border-b border-green-200 flex items-center justify-between w-full gap-2">
      <div className="flex items-center gap-2 sm:gap-4 min-w-0">
        ...
        <div className="flex flex-col min-w-0">
          <p className="text-[10px] sm:text-sm font-semibold text-primary truncate">Manajemen Pengelolaan Website</p>
          <p className="text-xs sm:text-sm md:text-lg lg:text-2xl font-semibold truncate">{session?.nama_unit}</p>
        </div>
      </div>
