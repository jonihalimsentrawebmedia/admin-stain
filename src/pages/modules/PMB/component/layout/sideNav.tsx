...
export function SideNavPMB({ collapsed, setCollapsed }: Props) {
  ...
  const menuPMB = useMemo(() => (menu ? mapMenu(menu) : []), [menu])
  ...
  useEffect(() => {
    const activeHasParentGroup = menuPMB.some((item) => {
