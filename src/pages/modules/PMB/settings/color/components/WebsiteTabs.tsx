...
import { UseGetColorAdminPMB } from '../hooks/index.tsx'
...
const WebsiteTabs = () => {
  ...
  const { color } = UseGetColorAdminPMB('public')
  ...
  const HandleSave = async (e: any) => {
    setLoading(true)
    await AxiosClient.post('/pmb/pengaturan-warna/public', {
