...
import { UseGetTemplateDetail } from '@/pages/modules/website-utama/settings-menu/template/hooks'
...
import ButtonReset from '@/pages/modules/website-utama/settings-menu/template/color/component/ButtonReset.tsx'
