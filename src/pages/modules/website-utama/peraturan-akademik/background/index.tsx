...
import { UseGetAcademicRulesBackground } from '../hooks/index.tsx'

export const AcademicRulesBackground = () => {
  const { background } = UseGetAcademicRulesBackground()

  return (
    <>
      <div className="flex flex-col gap-4">
        <ButtonTitleGroup buttonGroup={[]} label="Gambar Background - Peraturan Akademik" isBack />
        ...
        <UploadImgBackground
          queryName={'background-academic-rules'}
          background={background}
          context={'pengaturan-akademik-background'}
          max={4}
        />
      </div>
    </>
