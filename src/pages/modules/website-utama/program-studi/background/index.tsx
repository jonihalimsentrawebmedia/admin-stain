...
import { UseGetProdiBackground } from '../controller/useGetBg.tsx'

export const ProdiBackground = () => {
  const { background } = UseGetProdiBackground()
  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        ...
        <UploadImgBackground
          queryName={'background-prodi'}
          background={background}
          context={'program-studi-background'}
          max={4}
        />
      </div>
    </>
