  ...
  const [data] = useState([
    {
      id: 1,
      name: 'Gambaran Umum',
      link: `/modules/website-utama/program-studi/${id}/tentang`,
    },
    {
      id: 2,
      name: 'Unit Pengelola',
      link: `/modules/website-utama/program-studi/${id}/unit-pengelola`,
    },
    {
      id: 3,
      name: 'Visi, Misi, & Tujuan',
      link: `/modules/website-utama/program-studi/${id}/visi-misi`,
    },
    {
      id: 4,
      name: 'Struktur Organisasi',
      link: `/modules/website-utama/program-studi/${id}/struktur-organisasi`,
    },
    {
      id: 5,
      name: 'Staff',
      link: `/modules/website-utama/program-studi/${id}/staff`,
    },
    {
      id: 6,
      name: 'Dosen',
      link: `/modules/website-utama/program-studi/${id}/dosen`,
    },
    {
      id: 7,
      name: 'Berita',
      link: `/modules/website-utama/program-studi/${id}/berita`,
    },
    {
      id: 8,
      name: 'Galeri',
      link: `/modules/website-utama/program-studi/${id}/galeri`,
    },
    {
      id: 9,
      name: 'Hubungi Kami',
      link: `/modules/website-utama/program-studi/${id}/hubungi-kami`,
    },
  ])
  return (
    <div className="border w-full lg:w-[300px] p-2 flex shadow-lg flex-col gap-2">
      {data.map((item, index) => (
        <Link
          key={item.name + index}
          to={item.link}
