...
import { UseGetUKTBackground } from '../hooks'

export const UKTBackground = () => {
  const { background } = UseGetUKTBackground()
  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        ...
        <UploadImgBackground
          queryName={'background-ukt'}
          background={background}
          context={'biaya-pendidikan-ukt-background'}
          max={4}
        />
      </div>
    </>
