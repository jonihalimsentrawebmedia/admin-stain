...
import { UseGetNonUKTBackground } from '../hook'

export const NONUKTBackground = () => {
  const { background } = UseGetNonUKTBackground()
  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        <ButtonTitleGroup
          buttonGroup={[]}
          label="Gambar Background - Biaya Pendaftaran UKT"
          isBack
        />
        ...
        <UploadImgBackground
          queryName={'background-non-ukt'}
          background={background}
          context={'biaya-pendidikan-non-ukt-background'}
          max={4}
        />
      </div>
    </>
