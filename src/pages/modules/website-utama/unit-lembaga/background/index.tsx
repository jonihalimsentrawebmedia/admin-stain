...
import { UseGetUnitInstitutionBackground } from '../hooks/index.tsx'

export const UnitInstitutionBackgroundPage = () => {
  const { background } = UseGetUnitInstitutionBackground()
  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        ...
        <UploadImgBackground
          queryName={'unit-institution-background'}
          background={background}
          context={'satuan-organisasi/unit-lembaga-background'}
          max={4}
        />
      </div>
    </>
