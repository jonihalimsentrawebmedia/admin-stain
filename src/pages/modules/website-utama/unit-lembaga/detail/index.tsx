...
import { UseGetUnitInstitutionDetail } from '@/pages/modules/website-utama/unit-lembaga/hooks'
import { Separator } from '@/components/ui/separator.tsx'
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs.tsx'
import { clsx } from 'clsx'
import { FormAbout } from '@/pages/modules/website-utama/unit-lembaga/detail/component/formAbout.tsx'
import { useState } from 'react'
import VisionMissionForm from '@/pages/modules/website-utama/unit-lembaga/detail/component/formVision.tsx'
import OrganizationalStructureForm from '@/pages/modules/website-utama/unit-lembaga/detail/component/formOrganization.tsx'
import ContactUsForm from '@/pages/modules/website-utama/unit-lembaga/detail/component/formContact.tsx'

const DetailUnitInstitution = () => {
  const { id } = useParams()
  const { unitInstitutionDetail: detail } = UseGetUnitInstitutionDetail((id as string) ?? '')
...
export default DetailUnitInstitution
