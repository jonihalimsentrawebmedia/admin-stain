...
import { UseGetBackgroundInboxMessage } from '../hooks/index.tsx'

export const InboxMessageBackground = () => {
  const { background } = UseGetBackgroundInboxMessage()
