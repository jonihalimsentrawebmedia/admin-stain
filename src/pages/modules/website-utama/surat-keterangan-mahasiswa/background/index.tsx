...
import { UseGetLetterStudentBackground } from '../hook/index'

export const StudentLetterBackground = () => {
  const { background } = UseGetLetterStudentBackground()
  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        <ButtonTitleGroup
          buttonGroup={[]}
          label="Gambar Background - Surat Keterangan Mahasiswa"
          isBack
        />
        ...
        <UploadImgBackground
          queryName={'background-student-letter'}
          background={background}
          context={'surat-keterangan-mahasiswa-background'}
          max={4}
        />
      </div>
    </>
