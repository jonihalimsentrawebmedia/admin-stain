...
import { ButtonDraftAnnouncement } from '@/pages/modules/website-utama/public-content/announcement/components/buttonDraft.tsx'
import { format } from 'date-fns'
import { TimeAgo } from '@/utils/helper.tsx'
import { Button } from '@/components/ui/button.tsx'

export const SubmissionAnnouncementColumns = () => {
        ...
        return (
          <>
            <div className="flex flex-col gap-1.5 text-center">
              ...
              <ButtonDraftAnnouncement {...row?.original} />
            </div>
          </>
        )
      },
