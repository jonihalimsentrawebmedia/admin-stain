...
import { ButtonDraftAchievement } from '@/pages/modules/website-utama/public-content/achievement/components/buttonDraft.tsx'
        ...
        return (
          <>
            <div className="flex flex-col gap-1.5 text-center">
              ...
              <ButtonDraftAchievement {...row?.original} />
            </div>
          </>
        )
      },
