...
export const ButtonDraftAchievement = (data: IAchievementDetail) => {
  ...
  const HandleSubmission = async () => {
    setLoading(true)
    await AxiosClient.patch(`/website-utama/prestasi/${data?.id_prestasi}/status-publish`, {
  ...
  return (
    <>
      ...
      <DialogCustom
        ...
        description={'Apakah anda yakin untuk mengembalikan prestasi yang diajukan ke draft?'}
      >
