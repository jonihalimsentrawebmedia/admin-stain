...
import { UseGetGalleryVideoBackground } from '@/pages/modules/website-utama/public-content/gallery/video/hooks'

export const GalleryVideoBackgroundPage = () => {
  const { background } = UseGetGalleryVideoBackground()
  return (
    <>
      <div className="flex flex-col gap-4">
        <ButtonTitleGroup buttonGroup={[]} label="Gambar Background - Galeri Video" isBack />
        ...
        <UploadImgBackground
          queryName={'background-video'}
          background={background}
          context={'galeri-video-background'}
          max={4}
        />
      </div>
    </>
