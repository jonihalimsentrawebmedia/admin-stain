...
import { UnpublishColumnsImpactInnovation } from './unpublishColumns.tsx'

export const UnpublishSectionImpactInnovation = () => {
  ...
  const columns = UnpublishColumnsImpactInnovation()
