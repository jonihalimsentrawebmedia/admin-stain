...
import { ButtonDraftImpactInnovation } from '@/pages/modules/website-utama/public-content/impact-innovation/components/buttonDraft.tsx'
                ...
                <CarouselContent className={'w-fit'}>
                  {row?.original?.gambar_tambahan.map((item, index) => (
                    <CarouselItem key={index}>
                      <img
                        src={item?.gambar}
                        className={'min-w-[150px] lg:w-[300px] lg:h-[225px] object-cover'}
                        alt={item?.keterangan}
                      />
                    </CarouselItem>
                  ))}
        ...
        return (
          <>
            <div className="flex flex-col gap-1.5 text-center">
              ...
              <ButtonDraftImpactInnovation {...row?.original} />
            </div>
          </>
        )
      },
