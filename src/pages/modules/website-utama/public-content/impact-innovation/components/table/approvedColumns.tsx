...
import { ButtonPublishImpactInnovation } from '@/pages/modules/website-utama/public-content/impact-innovation/components/buttonPublish.tsx'

export const ApprovedColumnsImpactInnovation = () => {
  ...
  const columns: ColumnDef<IImpactInnovationList>[] = [
    ...
    },
    {
      ...
      header: 'Aksi',
      cell: ({ row }) => {
        return <ButtonPublishImpactInnovation {...row?.original} />
      },
    },
    {
      accessorKey: 'log',
