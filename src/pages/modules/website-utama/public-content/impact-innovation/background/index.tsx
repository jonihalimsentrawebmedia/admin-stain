...
import { UseGetInnovationBackground } from '@/pages/modules/website-utama/public-content/impact-innovation/hooks'

export const InnovationBackgroundPage = () => {
  const { background } = UseGetInnovationBackground()

  return (
    <>
      <div className="flex flex-col gap-4">
        <ButtonTitleGroup buttonGroup={[]} label="Gambar Background - Inovasi Berdampak" isBack />
        ...
        <UploadImgBackground
          ...
          context={'inovasi-berdampak-background'}
          max={4}
        />
      </div>
    </>
