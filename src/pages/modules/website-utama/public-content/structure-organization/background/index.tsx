...
import { UseGetStructureBackground } from '@/pages/modules/website-utama/public-content/structure-organization/hooks'

export const GroupOrganizationBackgroundPage = () => {
  const { background } = UseGetStructureBackground()

  return (
    <>
      <div className="flex flex-col gap-4">
        <ButtonTitleGroup buttonGroup={[]} label="Gambar Background - Struktur Organisasi" isBack />
        ...
        <UploadImgBackground
          queryName={'background-innovation'}
          background={background}
          context={'kelompok-organisasi-background'}
          max={4}
        />
      </div>
    </>
