...
export const PlacemanResolver = z.object({
  ...
  id_pangkat_golongan: z.string({ error: 'Pangkat Golongan Wajib Diisi' }).min(1),
  id_pangkat_akademik: z.string({ error: 'Pangkat Akademik Wajib Diisi' }).min(1),
  nama_lengkap: z
  ...
  nip: z.string({ error: 'NIP Wajib Diisi' }).min(1),
