...
import EditorProcessColumns from '@/pages/modules/website-utama/public-content/slider/bottom-slider/components/table/editorProcessColumns.tsx'

export const EditorProcessSection = () => {
  const columns = EditorProcessColumns()
