...
import BottomSubmissionColumns from '@/pages/modules/website-utama/public-content/slider/bottom-slider/components/table/submitColumns.tsx'
import { UseGetListBottomSlider } from '@/pages/modules/website-utama/public-content/slider/bottom-slider/hooks'

export const ButtomSubmitSection = () => {
  const columns = BottomSubmissionColumns()
