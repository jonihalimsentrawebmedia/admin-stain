...
import { UseGetCampusLifeBackground } from '../hooks/index.tsx'

export const CampusLifeBackground = () => {
  const { background } = UseGetCampusLifeBackground()
  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        ...
        <UploadImgBackground
          queryName={'background-campus-life'}
          background={background}
          context={'kehidupan-kampus-background'}
          max={4}
        />
      </div>
    </>
