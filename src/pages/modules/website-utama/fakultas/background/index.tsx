...
import { UseGetFacultyBackground } from '../controller/useGetBg.tsx'

export const FacultyBackground = () => {
  const { background } = UseGetFacultyBackground()
  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        ...
        <UploadImgBackground
          queryName={'background-faculty'}
          background={background}
          context={'fakultas-background'}
          max={4}
        />
      </div>
    </>
