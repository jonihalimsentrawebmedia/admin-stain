...
import { UseGetUkkUkmBackground } from '../hooks/index.tsx'

export const UkkUKMBackgroundPage = () => {
  const { background } = UseGetUkkUkmBackground()
  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        ...
        <UploadImgBackground
          queryName={'ukk-ukm-background'}
          background={background}
          context={'ukk-ukm-background'}
          max={4}
        />
      </div>
    </>
