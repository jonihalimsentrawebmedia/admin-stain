...
export default function DashboardLPPM() {
  ...
  const actions = [
    { label: 'Tulis Berita', url: '/modules/lppm/public-content/news/add' },
    { label: 'Tulis Pengumuman', url: '/modules/lppm/public-content/announcement/add' },
    { label: 'Tulis Agenda', url: '/modules/lppm/public-content/agenda/add' },
    { label: 'Tulis Artikel', url: '/modules/lppm/public-content/article/add' },
  ]
