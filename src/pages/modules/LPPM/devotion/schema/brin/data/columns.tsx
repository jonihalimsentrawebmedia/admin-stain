...
import { ButtonDeleteDataBRIN } from '../component/buttonDelete'
...
export const ColumnsDataDRTPM = () => {
  ...
  const columns: ColumnDef<IListBRIN>[] = [
    {
      accessorKey: 'order',
      header: '#',
      cell: ({ row }) => {
