...
import { UseGetArticleLppmDetail, UseGetLogArticleLppm } from '../hooks'

export const LogActivityArticleLppmPage = () => {
  const { id } = useParams()
  const { logData, loading, meta } = UseGetLogArticleLppm(id ?? '')
