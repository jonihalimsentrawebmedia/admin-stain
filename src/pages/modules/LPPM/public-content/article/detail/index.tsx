...
import { ButtonSubmissionArticleLppm } from '../components/buttonSubmission'
        ...
        buttonGroup={[
          {
            ...
            element: (
              <div className={'flex items-center gap-2'}>
                ...
                <Button
                  onClick={() =>
                    navigate(`/modules/lppm/public-content/article/edit/${detail?.id_artikel}`)
                  }
          ...
          },
          {
            ...
            element:
              detail?.status_publish === 'DRAFT' ? (
                <ButtonSubmissionArticleLppm {...(detail as any)} />
              ) : (
                <></>
              ),
          },
