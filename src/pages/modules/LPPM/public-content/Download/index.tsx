...
const DownloadFileLppmPage = () => {
  ...
  const { categoryDownload, meta: metaCategory, loading: load1 } = UseGetCategoryDownloadLppm()
  const { downloadLppm, meta, loading: load2 } = UseGetDownloadLppm()
  const columns = DownloadFileLppmColumns()
...
export default DownloadFileLppmPage
