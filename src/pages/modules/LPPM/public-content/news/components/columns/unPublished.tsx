...
import { ButtonPublishNewsLppm } from '../buttonPublish'
import { ButtonDeleteNewsLppm } from '../buttonDelete'

export const UnPublishColumnsLppm = () => {
  ...
  const columns: ColumnDef<INewsDetail>[] = [
      ...
      cell: ({ row }) => {
        return (
          <div className={'flex flex-col gap-1.5 items-center'}>
            ...
            <ButtonPublishNewsLppm {...row?.original} />
          </div>
        )
      },
    },
    ...
    },
    {
      ...
      cell: ({ row }) => {
        return (
          <div className={'flex flex-col gap-1.5 items-center'}>
            <ButtonDeleteNewsLppm {...row?.original} />
