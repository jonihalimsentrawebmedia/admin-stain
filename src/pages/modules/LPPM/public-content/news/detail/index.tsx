...
import { UseGetLppmNewsDetail } from '../hooks'
import { ButtonSubmissionNewsLppm } from '../components/buttonSubmission'

export const DetailNewsLppmPage = () => {
  const { id } = useParams()
  const { lppmNewsDetail: detail } = UseGetLppmNewsDetail(id ?? '')
        ...
        buttonGroup={[
          {
            ...
            element: (
              <div className={'flex items-center gap-2'}>
                ...
                <Button
                  onClick={() =>
                    navigate(`/modules/lppm/public-content/news/edit/${detail?.id_berita}`)
                  }
          ...
          },
          {
            ...
            element:
              detail?.status_publish === 'DRAFT' ? (
                <ButtonSubmissionNewsLppm {...(detail as any)} />
              ) : (
                <></>
              ),
          },
