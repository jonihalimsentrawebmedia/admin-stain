...
import { UseGetLogAnnouncementLppm, UseGetLppmAnnouncementDetail } from '../hooks/index'

export const LogActivityAnnouncementLppmPage = () => {
  const { id } = useParams()
  const columns = ColumnsLog()
  const { logData } = UseGetLogAnnouncementLppm(id ?? '')
