...
export const ButtonSubmissionAnnouncementLppm = (data: IAnnouncement) => {
  ...
  const HandleSubmission = async () => {
    setLoading(true)
    await AxiosClient.patch(`/lppm/pengumuman/${data?.id_pengumuman}/status-publish`, {
