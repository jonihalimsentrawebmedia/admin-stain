...
import { UseGetLppmAnnouncement } from '../hooks'
...
export const TableDataListAnnouncement = (props: props) => {
  ...
  const { loading, meta, lppmAnnouncement } = UseGetLppmAnnouncement({
  ...
  return (
    <>
      <TableCustom data={lppmAnnouncement} loading={loading} meta={meta} columns={columns} />
    </>
  )
}
