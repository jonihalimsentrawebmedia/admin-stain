...
import { ButtonDeleteAnnouncementLppm } from '../buttonDelete'
import { ButtonSubmissionAnnouncementLppm } from '../buttonSubmission'
          ...
          <>
            <div className={'flex flex-col gap-2 items-center'}>
              <div className="flex items-center gap-1">
                ...
                <ButtonDeleteAnnouncementLppm {...row?.original} />
              </div>
              <ButtonSubmissionAnnouncementLppm {...row?.original} />
            </div>
          </>
        )
      },
