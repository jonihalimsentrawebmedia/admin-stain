...
import { UseGetLppmAnnouncementStatus } from './hooks'
import { TableDataListAnnouncement } from './components/listAnnouncement'
import ButtonGoToGuide from '@/pages/modules/website-utama/panduan/components/ButtonGoToGuide'

export const AnnouncementLppmPublicContent = () => {
  const navigate = useNavigate()
  const { status } = UseGetLppmAnnouncementStatus()
          ...
          buttonGroup={[
            {
              ...
              element: (
                <ButtonGoToGuide
                  ...
                  valueGuide="LPPM_KONTEN_PUBLIK_PENGUMUMAN"
                />
              ),
            },
