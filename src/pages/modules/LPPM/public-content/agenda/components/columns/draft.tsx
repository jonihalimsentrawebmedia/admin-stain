...
import { ButtonDeleteAgendaLppm } from '../buttonDelete'
import { ButtonSubmissionAgendaLppm } from '../buttonSubmission'
          ...
          <>
            <div className={'flex flex-col gap-2 items-center'}>
              <div className="flex items-center gap-1">
                ...
                <ButtonDeleteAgendaLppm {...row?.original} />
              </div>
              <ButtonSubmissionAgendaLppm {...row?.original} />
            </div>
          </>
        )
      },
