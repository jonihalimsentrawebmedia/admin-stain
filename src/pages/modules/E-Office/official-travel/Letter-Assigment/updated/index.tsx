...
import { FaDownload, FaExternalLinkAlt, FaPrint } from 'react-icons/fa'
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between gap-2 pt-2">
            <div className="flex items-center gap-2">
              ...
              <Button className="text-white" disabled={!pdfUrl || pdfLoading} onClick={handlePrint}>
            ...
            <Button
              ...
              onClick={() => navigate('/modules/e-office/official-travel/letter-assignment')}
            >
