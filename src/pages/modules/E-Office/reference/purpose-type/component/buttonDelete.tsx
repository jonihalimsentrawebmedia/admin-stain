...
const ButtonDeletePurposeType = (props: props) => {
  const { data } = props
  ...
  const HandleSave = async () => {
    setLoading(true)
    await AxiosClient.delete(`/eoffice/jenis-keperluan/${data.id_jenis_keperluan}`)
      .then((res) => {
        if (res.data.status) {
          setLoading(false)
          setOpen(false)
...
export default ButtonDeletePurposeType
