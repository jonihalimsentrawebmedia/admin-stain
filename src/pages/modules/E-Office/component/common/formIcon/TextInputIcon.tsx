...
function TextInputIcon<T extends FieldValues>({
  label,
  type = 'text',
  htmlFor,
  placeholder,
    ...
    <FormField
      ...
      render={({ field }) => (
        ...
        >
          ...
          <FormControl>
            <div className="relative w-full flex items-center border rounded">
              {icon && <div className="p-2 h-full bg-primary/20">{icon}</div>}
              <Input
                id={htmlFor}
                min={min}
                ...
                className={`w-full border-none focus-visible:ring-0 rounded ${inputClassName}`}
