...
export const GenerateSKBKLetter = ({
  logo,
  data,
  header,
}: IGenerateLetterSKBK): TDocumentDefinitions => {
  ...
  return {
    ...
    content: [
        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              ':',
              `${data.kode_jenjang ?? ''} ${data.nama_jenjang ? `- ${data.nama_jenjang}` : ''}`,
            ],
          ],
        },
        layout: 'noBorders',
...

      {
        ...
        text: [
          'Berdasarkan hasil pemeriksaan administrasi keuangan, mahasiswa tersebut dinyatakan telah menyelesaikan seluruh kewajiban keuangan kepada ',
...

      {
        ...
        ol: data.daftar_kewajiban_keuangan.map((item) => ({
          text: item,
          alignment: 'justify',
        })),
      },
...

      {
        ...
        text: [
          ...
          {
            text: 'DINYATAKAN BEBAS KEUANGAN',
            bold: true,
          },

          ' dan tidak memiliki tunggakan administrasi keuangan pada ',
