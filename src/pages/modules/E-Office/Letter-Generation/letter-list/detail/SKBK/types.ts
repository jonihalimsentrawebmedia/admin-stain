...
export interface ISKBKLetter {
  id_mail_surat_bebas_keuangan: string
  ...
  // Field khusus Bebas Keuangan
  daftar_kewajiban_keuangan: string[]
  tujuan_pembuatan_surat: string[]
