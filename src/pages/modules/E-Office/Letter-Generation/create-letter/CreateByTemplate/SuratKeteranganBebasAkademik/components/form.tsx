...
import type { TResolverSKBA } from '@/pages/modules/E-Office/Letter-Generation/create-letter/CreateByTemplate/SuratKeteranganBebasAkademik/data/resolver.tsx'
...
const FormSuratKeteranganBebasAkademik = (props: Props) => {
  ...
  const {
    fields: akademikFields,
    append: appendAkademik,
    remove: removeAkademik,
  } = useFieldArray({
    control: form.control,
    name: 'daftar_kewajiban_akademik',
  } as any)
                  ...
                  <div className="flex flex-col gap-2 w-full">
                    {akademikFields.map((field, index) => (
                      <div key={field.id} className="flex items-center gap-2 w-full">
                        <TextInput
                          name={`daftar_kewajiban_akademik.${index}`}
                          form={form}
                        ...
                        <Button
                          ...
                          onClick={() => removeAkademik(index)}
                          disabled={akademikFields.length === 1}
                        >
                          <FaTrash />
                        </Button>
                      </div>
              ...
              <CardContent className={'p-2 space-y-4 w-full'}>
                ...
                <div className="space-y-4">
                  ...
                  <TextInput
                    ...
                    form={form}
                    label={'NIDN'}
                    placeholder={'NIDN Penandatangan'}
                    htmlFor={'NIDN'}
                    type={'number'}
                    isRow
                    isRequired
...
export default FormSuratKeteranganBebasAkademik
