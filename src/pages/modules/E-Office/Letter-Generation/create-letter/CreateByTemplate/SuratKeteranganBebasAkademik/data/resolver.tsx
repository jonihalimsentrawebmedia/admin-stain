...
export const ResolverSKBA = z.object({
  ...
  daftar_kewajiban_akademik: z.array(z.string({ error: 'Kewajiban Akademik harus diisi' })).min(1, { message: 'Minimal 1 Kewajiban Akademik' }),
  tujuan_pembuatan_surat: z.array(z.string({ error: 'Tujuan Pembuatan Surat harus diisi' })).min(1, { message: 'Minimal 1 Tujuan Pembuatan Surat' }),
...
export type TResolverSKBA = z.infer<typeof ResolverSKBA>
