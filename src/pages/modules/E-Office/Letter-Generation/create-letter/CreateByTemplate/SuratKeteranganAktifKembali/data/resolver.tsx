...
export const ResolverSKAK = z.object({
  ...
  semester_cuti: z.enum(['genap', 'ganjil'], { error: 'Semester Cuti harus Dipilih' }),
...
export type TResolverSKAK = z.infer<typeof ResolverSKAK>
